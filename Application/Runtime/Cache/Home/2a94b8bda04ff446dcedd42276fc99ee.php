...
<head>
    ...
    <link rel="stylesheet" href="/turingca/Public/Css/index.css" />
    <link rel="stylesheet" href="/turingca/Public/Css/bottom.css" />
    <link rel="stylesheet" href="/turingca/Public/Uploadify/uploadify.css"/>
    ...
    <script type="text/javascript" src='/turingca/Public/Uploadify/jquery.uploadify.min.js'>
    </script>
    <script type="text/javascript" src='/turingca/Public/Js/index.js'></script>
    <script type='text/javascript'>
        var PUBLIC = '/turingca/Public';
            ...
            <div class="weibo">
                ...
                <div class="face">
                    <a href="<?php echo U('/' . $v['uid']);?>">
                        <img src="
                        <?php if($v["face"]): ?>/turingca/Uploads/Face/<?php echo ($v["face"]); ?>
                        <?php else: ?>
                            /turingca/Public/Images/noface.gif<?php endif; ?>" width='50' height='50'/>
                    </a>
                </div>
                <div class="wb_cons">
                    <dl>
                    <!--用户名-->
                        <dt class='author'>
                            <a href="<?php echo U('/' . $v['uid']);?>"><?php echo ($v["nickname"]); ?></a>
                        </dt>
                    <!--发布内容-->
                        <dd class='content'>
                    ...
                    <?php if($v['max']): ?><dd>
                            <div class='wb_img'>
                            <!--小图-->
                                <img src="/turingca/Uploads/Pic/<?php echo ($v["mini"]); ?>" class='mini_img'/>
                                <div class="img_tool hidden">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <a href="/turingca/Uploads/Pic/<?php echo ($v["max"]); ?>" target='_blank'>&nbsp;查看大图</a>
                                        </li>
                                    </ul>
                                <!--中图-->
                                    <div class="img_info"><img src="/turingca/Uploads/Pic/<?php echo ($v["medium"]); ?>"/></div>
                                </div>
                            </div>
                        </dd><?php endif; ?>
                    </dl>
                ...
                <!--=====回复框=====-->
                    <div class='comment_load hidden'>
                        <img src="/turingca/Public/Images/loading.gif">评论加载中，请稍候...
                    </div>
                        ...
                        <dd>
                            <div class="wb_turn">
                                ...
                                <?php if($v["isturn"]["max"]): ?><dd>
                                        <div class="turn_img">
                                        <!--小图-->
                                            <img src="/turingca/Uploads/Pic/<?php echo ($v["isturn"]["mini"]); ?>" class='turn_mini_img'/>
                                            <div class="turn_img_tool hidden">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <i class='icon icon-bigpic'></i>
                                                        <a href="/turingca/Uploads/Pic/<?php echo ($v["isturn"]["max"]); ?>" target='_blank'>&nbsp;查看大图</a>
                                                    </li>
                                                </ul>
                                            <!--中图-->
                                                <div class="turn_img_info">
                                                    <img src="/turingca/Uploads/Pic/<?php echo ($v["isturn"]["medium"]); ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                    </dd><?php endif; ?>
...
<!--==========右侧==========-->
        <div id="right">
            ...
            <dl class="user_face">
                <dt>
                    <a href=""><img src="/turingca/Public/Images/noface.gif" width='80' height='80' alt="" /></a>
                </dt>
                <dd><a href="">后盾网</a></dd>
            </dl>
            <ul class='num_list'>
                ...
                <fieldset>
                    ...
                    <ul>
                        <li>
                            <dl>
                                <dt>
                                    <a href=""><img src="/turingca/Public/Images/noface.gif" alt="" width='30' height='30'/></a>
                                </dt>
                                <dd><a href="">后盾官网</a></dd>
                                <dd>共10个共同好友</dd>
                            </dl>
...
<!--==========表情选择框==========-->
    <div id="phiz" class='hidden'>
        ...
        <ul>
            <li><img src="/turingca/Public/Images/phiz/hehe.gif" alt="呵呵" title="呵呵" /></li>
            <li><img src="/turingca/Public/Images/phiz/xixi.gif" alt="嘻嘻" title="嘻嘻" /></li>
            <li><img src="/turingca/Public/Images/phiz/haha.gif" alt="哈哈" title="哈哈" /></li>
            <li><img src="/turingca/Public/Images/phiz/keai.gif" alt="可爱" title="可爱" /></li>
            <li><img src="/turingca/Public/Images/phiz/kelian.gif" alt="可怜" title="可怜" /></li>
            <li><img src="/turingca/Public/Images/phiz/wabisi.gif" alt="挖鼻屎" title="挖鼻屎" /></li>
            <li><img src="/turingca/Public/Images/phiz/chijing.gif" alt="吃惊" title="吃惊" /></li>
            <li><img src="/turingca/Public/Images/phiz/haixiu.gif" alt="害羞" title="害羞" /></li>
            <li><img src="/turingca/Public/Images/phiz/jiyan.gif" alt="挤眼" title="挤眼" /></li>
            <li><img src="/turingca/Public/Images/phiz/bizui.gif" alt="闭嘴" title="闭嘴" /></li>
            <li><img src="/turingca/Public/Images/phiz/bishi.gif" alt="鄙视" title="鄙视" /></li>
            <li><img src="/turingca/Public/Images/phiz/aini.gif" alt="爱你" title="爱你" /></li>
            <li><img src="/turingca/Public/Images/phiz/lei.gif" alt="泪" title="泪" /></li>
            <li><img src="/turingca/Public/Images/phiz/touxiao.gif" alt="偷笑" title="偷笑" /></li>
            <li><img src="/turingca/Public/Images/phiz/qinqin.gif" alt="亲亲" title="亲亲" /></li>
            <li><img src="/turingca/Public/Images/phiz/shengbin.gif" alt="生病" title="生病" /></li>
            <li><img src="/turingca/Public/Images/phiz/taikaixin.gif" alt="太开心" title="太开心" /></li>
            <li><img src="/turingca/Public/Images/phiz/ldln.gif" alt="懒得理你" title="懒得理你" /></li>
            <li><img src="/turingca/Public/Images/phiz/youhenhen.gif" alt="右哼哼" title="右哼哼" /></li>
            <li><img src="/turingca/Public/Images/phiz/zuohenhen.gif" alt="左哼哼" title="左哼哼" /></li>
            <li><img src="/turingca/Public/Images/phiz/xiu.gif" alt="嘘" title="嘘" /></li>
            <li><img src="/turingca/Public/Images/phiz/shuai.gif" alt="衰" title="衰" /></li>
            <li><img src="/turingca/Public/Images/phiz/weiqu.gif" alt="委屈" title="委屈" /></li>
            <li><img src="/turingca/Public/Images/phiz/tu.gif" alt="吐" title="吐" /></li>
            <li><img src="/turingca/Public/Images/phiz/dahaqian.gif" alt="打哈欠" title="打哈欠" /></li>
            <li><img src="/turingca/Public/Images/phiz/baobao.gif" alt="抱抱" title="抱抱" /></li>
            <li><img src="/turingca/Public/Images/phiz/nu.gif" alt="怒" title="怒" /></li>
            <li><img src="/turingca/Public/Images/phiz/yiwen.gif" alt="疑问" title="疑问" /></li>
            <li><img src="/turingca/Public/Images/phiz/canzui.gif" alt="馋嘴" title="馋嘴" /></li>
            <li><img src="/turingca/Public/Images/phiz/baibai.gif" alt="拜拜" title="拜拜" /></li>
            <li><img src="/turingca/Public/Images/phiz/sikao.gif" alt="思考" title="思考" /></li>
            <li><img src="/turingca/Public/Images/phiz/han.gif" alt="汗" title="汗" /></li>
            <li><img src="/turingca/Public/Images/phiz/kun.gif" alt="困" title="困" /></li>
            <li><img src="/turingca/Public/Images/phiz/shuijiao.gif" alt="睡觉" title="睡觉" /></li>
            <li><img src="/turingca/Public/Images/phiz/qian.gif" alt="钱" title="钱" /></li>
            <li><img src="/turingca/Public/Images/phiz/shiwang.gif" alt="失望" title="失望" /></li>
            <li><img src="/turingca/Public/Images/phiz/ku.gif" alt="酷" title="酷" /></li>
            <li><img src="/turingca/Public/Images/phiz/huaxin.gif" alt="花心" title="花心" /></li>
            <li><img src="/turingca/Public/Images/phiz/heng.gif" alt="哼" title="哼" /></li>
            <li><img src="/turingca/Public/Images/phiz/guzhang.gif" alt="鼓掌" title="鼓掌" /></li>
            <li><img src="/turingca/Public/Images/phiz/yun.gif" alt="晕" title="晕" /></li>
            <li><img src="/turingca/Public/Images/phiz/beishuang.gif" alt="悲伤" title="悲伤" /></li>
            <li><img src="/turingca/Public/Images/phiz/zuakuang.gif" alt="抓狂" title="抓狂" /></li>
            <li><img src="/turingca/Public/Images/phiz/heixian.gif" alt="黑线" title="黑线" /></li>
            <li><img src="/turingca/Public/Images/phiz/yinxian.gif" alt="阴险" title="阴险" /></li>
            <li><img src="/turingca/Public/Images/phiz/numa.gif" alt="怒骂" title="怒骂" /></li>
            <li><img src="/turingca/Public/Images/phiz/xin.gif" alt="心" title="心" /></li>
            <li><img src="/turingca/Public/Images/phiz/shuangxin.gif" alt="伤心" title="伤心" /></li>
        </ul>
    </div>
<!--==========表情==========-->
